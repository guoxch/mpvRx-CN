...
object LocalModelCatalog {
  ...
  private val southAsianLanguages =
    listOf(
      "Hindi",
      "Urdu",
      "Bengali",
  ...
  val models: List<LocalModelInfo> =
    listOf(
      LocalModelInfo(
        ...
        contextLength = 32768,
        description =
          "Smallest useful default. Loads fast, answers fast, good first pick for subtitle translation on most phones.",
      ...
      LocalModelInfo(
        ...
        contextLength = 32768,
        description =
          "Very responsive for English and common languages. Better for rename/cleanup than broad translation.",
        chatTemplate = "llama",
        tier = LocalModelTier.FASTEST,
      ...
      LocalModelInfo(
        ...
        contextLength = 8192,
        description =
          "Best pick for broad and lower-resource multilingual subtitles. Heavier, but worth it when translation quality matters.",
        chatTemplate = "gemma",
        ...
        bestLanguages =
          europeanLanguages + southAsianLanguages + asianLanguages +
            listOf(
              "Arabic",
              "Persian",
              "Hebrew",
      ...
      LocalModelInfo(
        ...
        contextLength = 32768,
        description =
          "Utility model for rename, formatting, and reasoning-style cleanup. Not the default for subtitles.",
        chatTemplate = "phi",
  ...
  fun recommendedForRam(ramMb: Int): List<LocalModelInfo> = speedFirst(ramMb).filter { it.minRamGb * 1024 <= ramMb }

  fun bestForTranslation(
      ...
      .sortedWith(
        compareByDescending<LocalModelInfo> {
          it.bestLanguages.any { lang ->
            lowerLanguage.contains(lang.lowercase())
          }
        }.thenByDescending { it.translationRank }
          .thenByDescending { it.speedRank },
      ).firstOrNull()
