  ...
  override fun Content() {
    ...
    LaunchedEffect(updateState) {
        if (BuildConfig.ENABLE_UPDATE_FEATURE && updateViewModel != null && updateState is UpdateViewModel.UpdateState.NoUpdate) {
            Toast.makeText(context, context.getString(R.string.about_already_latest_toast), Toast.LENGTH_SHORT).show()
    ...
    Scaffold(
      ...
      Column(
              ...
              Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Column(modifier = Modifier.weight(1f)) {
                  ...
                  Surface(
                    ...
                    Text(
                      text = stringResource(R.string.about_by_author),
        ...
        PreferenceSectionHeader(title = stringResource(R.string.about_section_support))
        PreferenceCard {
            Column(modifier = Modifier.padding(16.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(
                        text = stringResource(R.string.about_buy_me_coffee),
                        style = MaterialTheme.typography.titleMedium,
                        fontWeight = FontWeight.Bold,
                        color = cs.onSurface,
                    )
                ...
                Text(
                    text = stringResource(R.string.about_donation_description),
                    style = MaterialTheme.typography.bodyMedium,
                    ...
                    Row(
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                Toast.makeText(context, context.getString(R.string.about_upi_id_copied_toast), Toast.LENGTH_SHORT).show()
                            }
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.cd_copy_upi_id),
                            modifier = Modifier.size(20.dp),
                            tint = cs.primary,
                        )
                    }
                ...
                Button(
                    onClick = {
                        try {
                            ...
                            Toast.makeText(context, context.getString(R.string.about_no_upi_app_toast), Toast.LENGTH_SHORT).show()
                        }
                    },
                ...
                Column {
                    Row(
                        ...
                        Column(
                            ...
                            Text(
                                text = stringResource(R.string.about_auto_check_updates),
                                style = MaterialTheme.typography.titleMedium,
                                fontWeight = FontWeight.SemiBold,
                                color = cs.onSurface
                            )
        ...
        PreferenceSectionHeader(title = stringResource(R.string.about_section_system))
