  ...
  Scaffold(
    topBar = {
      if (isSearching) {
        ...
        BrowserTopBar(
          title = stringResource(app.gyrolet.mpvrx.R.string.browser_media_library_title),
      ...
      if (isSearching && filteredVideosWithInfo.isEmpty() && searchQuery.isNotBlank()) {
        Box(
          ...
          EmptyState(
            ...
            title = stringResource(app.gyrolet.mpvrx.R.string.browser_search_no_videos_title),
